		...
		<div className="background">
			...
			<div className="description-grid-container">
				...
				<div className="tag-list">
					<div className="tag-list-item">Linux</div>
					<div className="tag-list-item">C</div>
					<div className="tag-list-item">Memory Allocation</div>
					<div className="tag-list-item">Pointers</div>
					<div className="tag-list-item">Linked List</div>
					<div className="tag-list-item">Command Prompt</div>
					<div className="tag-list-item">Signals</div>
					<div className="tag-list-item">Files</div>
					<div className="tag-list-item">Wildcards</div>
					<div className="tag-list-item">Arguments</div>
					<div className="tag-list-item">Environment Variables</div>
				</div>
			</div>
