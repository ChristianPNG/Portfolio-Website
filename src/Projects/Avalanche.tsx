    ...
    return (
        <div className="background">
            <div className="title">
                ...
                <span style={{ marginRight: "24pt" }}>Avalanche</span>
            </div>
            ...
            <div className="description-grid-container">
                <p>
                    <ul>
                        <li>
                            Collaborative game development of a simple yet
                            smooth flash game about a marshmallow trying to get
                            the highest score possible by climbing falling
                            blocks
                        </li>
                        <li>
                            Game can be ran at high frame rates with smooth
                            movement and collision detection
                        </li>
                        <li>
                            Designed with no added libraries and only on simple
                            js and css
                        </li>
                    </ul>
                    <a
            ...
            <div className="gallary">
                <Gallary images={AvalImages} videos={AvalVideos}></Gallary>
            </div>
        </div>
    );
}
