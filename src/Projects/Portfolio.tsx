...
export function Portfolio(): JSX.Element {
	...
	return (
		<div className="background">
			...
			<p>
					<ul>
						<li>Developed an engaging portfolio website utilizing React, Typescript, HTML, CSS featuring a unique display for each project, enhancing user experience and navigation.</li>
						<li>Designed aesthetically pleasing layouts and user interfaces for showcasing software projects, incorporating GIF demos and static images to provide comprehensive project overviews.</li>
						<li>Implemented connections to GitHub repositories for each project, allowing visitors to access source code</li>
						<li>Integrated client-side routing using frameworks like React Router, enabling smooth navigation between project pages without the need for page reloads</li>
					</ul>
					<a
